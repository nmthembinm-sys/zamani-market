...
<div class="container mt-5">
    ...
    <a href="orders.php" class="btn btn-primary mb-3"  style="background-color:#a379c3;">Go to Orders</a>
<?php
    $user_id = $_SESSION['user_id'];

$sql = "SELECT * FROM disputes WHERE raised_by = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $user_id);
$stmt->execute();
